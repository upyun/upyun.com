  ...
  div(slot="page")
    .about-page.terms
      .container
        .unit
          .title 服务协议
          .sub-title upyun.com 服务（以下简称“本服务”）是由杭州又拍云科技有限公司（以下简称“本公司”）向 upyun.com 用户提供的云存储网络服务，详见 upyun.com 网站（以下简称“本网站”）上相关产品及服务介绍。本协议由您和本公司签订。
        .unit.terms-content
          h3 1 总则
          p
          ...
          p
            ...
            br
            | 2.1.1 注册者资格
            span.bold 您确认，在您完成注册程序或以其他本公司允许的方式实际使用本服务时，您应当是具备完全民事权利能力和完全民事行为能力的自然人、法人或其他组织。若您不具备前述主体资格，则您及您的监护人、设立人应承担因此而导致的一切后果，且本公司有权注销您的帐户及删除您所存储的静态文件，并向您及您的监护人、设立人索偿。
            br
            | 2.1.2 注册和帐户
            br
          ...
          h3 3 您的权利和义务
          p
            | 3.1 您有权利享受又拍云提供的互联网技术和信息服务，并有权利在接受又拍云提供的服务时获得又拍云的技术支持、咨询等服务，服务内容详见upyun.com网站。
            br
            | 3.2 您保证不会利用技术或其他手段破坏或扰乱本网站及又拍云其他客户的网站。
            br
            ...
            br
            | 3.4 对由于您向upyun.com提供的联络方式有误以及您用于接受upyun.com邮件的电子邮箱安全性、稳定性不佳而导致的一切后果，您应自行承担责任，包括但不限于因您未能及时收到upyun.com的相关通知而导致的后果和损失。
            br
            ...
            br
            | 3.8 您保证您使用本服务时将遵从国家、地方法律法规、行业惯例和社会公共道德，不会利用本公司提供的服务进行存储、发布、传播如下信息和内容：违反国家法律法规政策的任何内容（信息）；违反国家规定的政治宣传和/或新闻信息；涉及国家秘密和/或安全的信息；封建迷信和/或淫秽、色情、下流的信息或教唆犯罪的信息；博彩有奖、赌博游戏；违反国家民族和宗教政策的信息；防碍互联网运行安全的信息；侵害他人合法权益的信息和/或其他有损于社会秩序、社会治安、公共道德的信息或内容。您同时承诺不得为他人发布上述不符合国家规定和/或本服务条款约定的信息内容提供任何便利，包括但不限于设置URL、BANNER链接等。您承认本公司有权在您违反上述约定时有权终止向您提供服务、删除您存储的静态文件并不予退还任何款项，因您上述行为给本公司造成损失的，您应予赔偿。
          ...
          p
            ...
            span.bold 5.4 广告
            br
            | 本公司会对upyun.com用户的身份数据进行综合统计，并出于销售和奖励的需要使用或披露。
            br
            span.bold 5.5 服务信息的收集和存储
            br
            | 出于 a.提供服务必须收集，否则服务无法提供，和 b.改善我们的产品和服务，以期更好地满足您的需求，为您提供定制化服务，否则您的产品或者服务体验相对会弱化的目的，本公司有可能自动从您的智能终端（包括手机、电脑和电视等）和浏览器上收集和存储您的软件信息、硬件信息、您主动上传至本网站服务器的信息及您使用偏好信息，上述信息包括但不限于您手机IMEI号，用户名，操作系统信息，您的IP地址，Cookie信息，GPS等位置服务使用情况，您所访问的页面等信息。
            br
            span.bold 5.6 外部链接
            br
          ...
          h3 6 不可抗力
          p 6.1 本条所称“不可抗力”是指不能预见、不能避免或不能克服的客观事件，包括但不限于自然灾害如洪水、火灾、爆炸、雷电、地震和风暴等以及社会事件如基础电信运营商网络出现严重电力或网络故障，战争、动乱、政府行为、国家政策的突然变动和罢工等。
          ...
          h3 11 法律适用与管辖
          p 本协议之效力、解释、变更、执行与争议解决均适用中华人民共和国法律。因本协议产生之争议，均应依照中华人民共和国法律予以处理，并提交本公司所在地法院审理。
</template>
