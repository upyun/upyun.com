...
import icon from './hero_icons/cdn_icon'
...
export default {
  data () {
    return {
      ...
      points: [
        { left: '849px', top: '224px', color: 'green' },
        { left: '879px', top: '224px', color: 'red' },
        ...
        { left: '876px', top: '254px', content: '香港', color: 'black' },
        { left: '895px', top: '238px', content: '台湾', color: 'black' }
      ]
    }
  },
  head: {
