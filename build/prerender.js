...
webpackConfig.plugins.push(
  new PrerenderSpaPlugin(
    ...
    ['/', '/products/file-storage', '/products/cdn', '/products/process', '/products/marketing', '/products/vod', '/products/live', '/solutions/meida', '/solutions/mobile', '/solutions/ecommerce', '/solutions/game', '/solutions/education', '/solutions/fusionstorage', '/about_us', '/contact', '/terms', '/mobile_stats_terms', '/partners', '/join_us', '/pricing', '/price_instruction', '/webp', '/league', '/chunyu', '/chunyu_tos', '/https', '/media_reports', '/brandnew', '/promotion']
  )
)
